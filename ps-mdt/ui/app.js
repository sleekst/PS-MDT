    ...
    if (eventData.type == "show") {
     ...
     /*  let fireCount = 0; */
      ...
      activeUnits.forEach((unit) => {
        ...
        let status = unit.duty == 1 ? "State 1" : 'State 4';
        ...
        if (PoliceJobs[unit.unitType] !== undefined) {
          ...
          activeInfoJob = `<div class="unit-job active-info-job-lspd">MPS</div>`;
            ...
            activeInfoJob = `<div class="unit-job active-info-job-bcso">MPS</div>`;
          } else if(unit.unitType == "lssd")  { bcsoCount++;
            activeInfoJob = `<div class="unit-job active-info-job-bcso">MPS</div>`;
          } else if(unit.unitType == "sasp")  { saspCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sasp">MPS</div>`;
          } else if(unit.unitType == "sast")  { saspCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sasp">MPS</div>`;
          } else if(unit.unitType == "sapr")  { saspCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sapr">MPS</div>`;
            ...
            activeInfoJob = `<div class="unit-job active-info-job-doc">NHS</div>`;
          }
